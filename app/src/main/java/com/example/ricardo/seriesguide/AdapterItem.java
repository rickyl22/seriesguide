...
public class AdapterItem extends RecyclerView.Adapter<AdapterItem.ViewHolderItem> implements View.OnClickListener {
    ...
    public AdapterItem(ArrayList<Season> datoss) {
        this.datos = datoss;
    }
